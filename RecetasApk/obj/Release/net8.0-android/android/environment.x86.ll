...
@dso_cache = dso_local local_unnamed_addr global [634 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 240861985, ; hash 0xe5b4321, from name: aot-RecetasApk
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 333242376, ; hash 0x13dce008, from name: aot-RecetasApk.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecetasApk.dll.so
		ptr null; void* handle (0x0)
	}, ; 43
	...
	%struct.DSOCacheEntry {
		i64 958081605, ; hash 0x391b2a45, from name: libaot-RecetasApk.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecetasApk.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 1337578538, ; hash 0x4fb9d42a, from name: libaot-RecetasApk
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecetasApk.dll.so
		ptr null; void* handle (0x0)
	}, ; 178
	...
	%struct.DSOCacheEntry {
		i64 3537655842, ; hash 0xd2dc5822, from name: RecetasApk
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecetasApk.dll.so
		ptr null; void* handle (0x0)
	}, ; 522
	...
	%struct.DSOCacheEntry {
		i64 4266446715, ; hash 0xfe4ccf7b, from name: RecetasApk.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RecetasApk.dll.so
		ptr null; void* handle (0x0)
	}, ; 626
